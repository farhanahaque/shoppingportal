	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="panel-footer"><center><img src="copyr.png" height="15px" width="15px">&nbsp;<img src="simpliciashop.ico" height="15px" width="15px">&nbsp;Simplicia Shop&nbsp;All rights reserved</center><div id="e_msg"></div></div>
			</div>
		</div>
		<div class="col-md-4"></div>
	</div>
